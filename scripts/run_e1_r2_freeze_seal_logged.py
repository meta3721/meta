#!/usr/bin/env python3
"""Run one freeze-seal command and append its exact audit record."""
...
def main() -> int:
    ...
    log_dir = root / "logs/e1_r2_freeze_seal"
    ...
    ledger = root / "logs/E1_R2_FORMAL_FREEZE_SEAL_R1_EXACT_COMMANDS.jsonl"
