#!/usr/bin/env python3
"""Append one exact command record for E1-R2 final report synchronization."""
...
def main() -> int:
    ...
    log_dir = root / "logs/e1_r2_final_report_sync"
        ...
        if path.is_file():
            ...
            for child in sorted(path.rglob("*")):
                if child.is_file():
                    ...
                    output_paths.append(relative)
                    output_hashes[relative] = _hash(child)
    ...
    ledger = root / "logs/E1_R2_FINAL_REPORT_SYNCHRONIZATION_R1_EXACT_COMMANDS.jsonl"
